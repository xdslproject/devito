...
#pragma omp simd aligned(tau_sol_xx, tau_sol_xz, tau_sol_zz, v_sol_x, v_sol_z : 32)
                    for (int z = z_m; z <= z_M; z += 1)
                    {
                      ...
                      float r25 = 1.0 / h_y;
                      float r24 = 1.0 / h_x;
                      v_sol_x[t1][x + 8][y + 8][z + 8] = r24 * (4.56702358488521e-4F * (tau_sol_xx[t0][x + 5][y + 8][z + 8] - tau_sol_xx[t0][x + 12][y + 8][z + 8]) + 6.2659563586471e-3F * (-tau_sol_xx[t0][x + 6][y + 8][z + 8] + tau_sol_xx[t0][x + 11][y + 8][z + 8]) + 5.22163029879319e-2F * (tau_sol_xx[t0][x + 7][y + 8][z + 8] - tau_sol_xx[t0][x + 10][y + 8][z + 8]) + 7.8324454477134e-1F * (-tau_sol_xx[t0][x + 8][y + 8][z + 8] + tau_sol_xx[t0][x + 9][y + 8][z + 8])) + r25 * (4.56702358488521e-4F * (tau_sol_xy[t0][x + 8][y + 4][z + 8] - tau_sol_xy[t0][x + 8][y + 11][z + 8]) + 6.2659563586471e-3F * (-tau_sol_xy[t0][x + 8][y + 5][z + 8] + tau_sol_xy[t0][x + 8][y + 10][z + 8]) + 5.22163029879319e-2F * (tau_sol_xy[t0][x + 8][y + 6][z + 8] - tau_sol_xy[t0][x + 8][y + 9][z + 8]) + 7.8324454477134e-1F * (-tau_sol_xy[t0][x + 8][y + 7][z + 8] + tau_sol_xy[t0][x + 8][y + 8][z + 8])) + r26 * (4.56702358488521e-4F * (tau_sol_xz[t0][x + 8][y + 8][z + 4] - tau_sol_xz[t0][x + 8][y + 8][z + 11]) + 6.2659563586471e-3F * (-tau_sol_xz[t0][x + 8][y + 8][z + 5] + tau_sol_xz[t0][x + 8][y + 8][z + 10]) + 5.22163029879319e-2F * (tau_sol_xz[t0][x + 8][y + 8][z + 6] - tau_sol_xz[t0][x + 8][y + 8][z + 9]) + 7.8324454477134e-1F * (-tau_sol_xz[t0][x + 8][y + 8][z + 7] + tau_sol_xz[t0][x + 8][y + 8][z + 8])) + v_sol_x[t0][x + 8][y + 8][z + 8];
                      v_sol_y[t1][x + 8][y + 8][z + 8] = r24 * (4.56702358488521e-4F * (tau_sol_xy[t0][x + 4][y + 8][z + 8] - tau_sol_xy[t0][x + 11][y + 8][z + 8]) + 6.2659563586471e-3F * (-tau_sol_xy[t0][x + 5][y + 8][z + 8] + tau_sol_xy[t0][x + 10][y + 8][z + 8]) + 5.22163029879319e-2F * (tau_sol_xy[t0][x + 6][y + 8][z + 8] - tau_sol_xy[t0][x + 9][y + 8][z + 8]) + 7.8324454477134e-1F * (-tau_sol_xy[t0][x + 7][y + 8][z + 8] + tau_sol_xy[t0][x + 8][y + 8][z + 8])) + r25 * (4.56702358488521e-4F * (t_yy[t0][x + 8][y + 5][z + 8] - t_yy[t0][x + 8][y + 12][z + 8]) + 6.2659563586471e-3F * (-t_yy[t0][x + 8][y + 6][z + 8] + t_yy[t0][x + 8][y + 11][z + 8]) + 5.22163029879319e-2F * (t_yy[t0][x + 8][y + 7][z + 8] - t_yy[t0][x + 8][y + 10][z + 8]) + 7.8324454477134e-1F * (-t_yy[t0][x + 8][y + 8][z + 8] + t_yy[t0][x + 8][y + 9][z + 8])) + r26 * (4.56702358488521e-4F * (tau_sol_yz[t0][x + 8][y + 8][z + 4] - tau_sol_yz[t0][x + 8][y + 8][z + 11]) + 6.2659563586471e-3F * (-tau_sol_yz[t0][x + 8][y + 8][z + 5] + tau_sol_yz[t0][x + 8][y + 8][z + 10]) + 5.22163029879319e-2F * (tau_sol_yz[t0][x + 8][y + 8][z + 6] - tau_sol_yz[t0][x + 8][y + 8][z + 9]) + 7.8324454477134e-1F * (-tau_sol_yz[t0][x + 8][y + 8][z + 7] + tau_sol_yz[t0][x + 8][y + 8][z + 8])) + v_sol_y[t0][x + 8][y + 8][z + 8];
                      v_sol_z[t1][x + 8][y + 8][z + 8] = r24 * (4.56702358488521e-4F * (tau_sol_xz[t0][x + 4][y + 8][z + 8] - tau_sol_xz[t0][x + 11][y + 8][z + 8]) + 6.2659563586471e-3F * (-tau_sol_xz[t0][x + 5][y + 8][z + 8] + tau_sol_xz[t0][x + 10][y + 8][z + 8]) + 5.22163029879319e-2F * (tau_sol_xz[t0][x + 6][y + 8][z + 8] - tau_sol_xz[t0][x + 9][y + 8][z + 8]) + 7.8324454477134e-1F * (-tau_sol_xz[t0][x + 7][y + 8][z + 8] + tau_sol_xz[t0][x + 8][y + 8][z + 8])) + r25 * (4.56702358488521e-4F * (tau_sol_yz[t0][x + 8][y + 4][z + 8] - tau_sol_yz[t0][x + 8][y + 11][z + 8]) + 6.2659563586471e-3F * (-tau_sol_yz[t0][x + 8][y + 5][z + 8] + tau_sol_yz[t0][x + 8][y + 10][z + 8]) + 5.22163029879319e-2F * (tau_sol_yz[t0][x + 8][y + 6][z + 8] - tau_sol_yz[t0][x + 8][y + 9][z + 8]) + 7.8324454477134e-1F * (-tau_sol_yz[t0][x + 8][y + 7][z + 8] + tau_sol_yz[t0][x + 8][y + 8][z + 8])) + r26 * (4.56702358488521e-4F * (tau_sol_zz[t0][x + 8][y + 8][z + 5] - tau_sol_zz[t0][x + 8][y + 8][z + 12]) + 6.2659563586471e-3F * (-tau_sol_zz[t0][x + 8][y + 8][z + 6] + tau_sol_zz[t0][x + 8][y + 8][z + 11]) + 5.22163029879319e-2F * (tau_sol_zz[t0][x + 8][y + 8][z + 7] - tau_sol_zz[t0][x + 8][y + 8][z + 10]) + 7.8324454477134e-1F * (-tau_sol_zz[t0][x + 8][y + 8][z + 8] + tau_sol_zz[t0][x + 8][y + 8][z + 9])) + v_sol_z[t0][x + 8][y + 8][z + 8];
                    }
                  }
                }
              }
...
#pragma omp simd aligned(tau_sol_xx, tau_sol_xz, tau_sol_zz, v_sol_x, v_sol_z : 32)
                    for (int z = z_m; z <= z_M; z += 1)
                    {
                      ...
                      float r47 = -v_sol_z[t1][x + 8][y + 8][z + 8];
                      float r46 = -v_sol_y[t1][x + 8][y + 8][z + 8];
                      float r45 = -v_sol_x[t1][x + 8][y + 8][z + 8];
                      float r44 = -v_sol_y[t1][x + 8][y + 7][z + 8] + v_sol_y[t1][x + 8][y + 8][z + 8];
                      float r43 = v_sol_y[t1][x + 8][y + 6][z + 8] - v_sol_y[t1][x + 8][y + 9][z + 8];
                      float r42 = -v_sol_y[t1][x + 8][y + 5][z + 8] + v_sol_y[t1][x + 8][y + 10][z + 8];
                      float r41 = v_sol_y[t1][x + 8][y + 4][z + 8] - v_sol_y[t1][x + 8][y + 11][z + 8];
                      float r40 = -v_sol_z[t1][x + 8][y + 8][z + 7] + v_sol_z[t1][x + 8][y + 8][z + 8];
                      float r39 = v_sol_z[t1][x + 8][y + 8][z + 6] - v_sol_z[t1][x + 8][y + 8][z + 9];
                      float r38 = -v_sol_z[t1][x + 8][y + 8][z + 5] + v_sol_z[t1][x + 8][y + 8][z + 10];
                      float r37 = v_sol_z[t1][x + 8][y + 8][z + 4] - v_sol_z[t1][x + 8][y + 8][z + 11];
                      float r36 = -v_sol_x[t1][x + 7][y + 8][z + 8] + v_sol_x[t1][x + 8][y + 8][z + 8];
                      float r35 = v_sol_x[t1][x + 6][y + 8][z + 8] - v_sol_x[t1][x + 9][y + 8][z + 8];
                      float r34 = -v_sol_x[t1][x + 5][y + 8][z + 8] + v_sol_x[t1][x + 10][y + 8][z + 8];
                      float r33 = v_sol_x[t1][x + 4][y + 8][z + 8] - v_sol_x[t1][x + 11][y + 8][z + 8];
                      float r32 = 1.0 / h_y;
                      float r31 = 1.0 / h_z;
                      float r30 = 1.0 / h_x;
                      ...
                      tau_sol_xx[t1][x + 8][y + 8][z + 8] = r27 + r28 + r30 * (5.91886256601123e-3F * r33 + 8.12067944080664e-2F * r34 + 6.76723286723597e-1F * r35 + 1.01508493002366e+1F * r36) + tau_sol_xx[t0][x + 8][y + 8][z + 8];
                      tau_sol_xy[t1][x + 8][y + 8][z + 8] = r30 * (2.53771232505914F * (r46 + v_sol_y[t1][x + 9][y + 8][z + 8]) + 1.47971564150281e-3F * (v_sol_y[t1][x + 5][y + 8][z + 8] - v_sol_y[t1][x + 12][y + 8][z + 8]) + 2.03016986020166e-2F * (-v_sol_y[t1][x + 6][y + 8][z + 8] + v_sol_y[t1][x + 11][y + 8][z + 8]) + 1.69180821680899e-1F * (v_sol_y[t1][x + 7][y + 8][z + 8] - v_sol_y[t1][x + 10][y + 8][z + 8])) + r32 * (2.53771232505914F * (r45 + v_sol_x[t1][x + 8][y + 9][z + 8]) + 1.47971564150281e-3F * (v_sol_x[t1][x + 8][y + 5][z + 8] - v_sol_x[t1][x + 8][y + 12][z + 8]) + 2.03016986020166e-2F * (-v_sol_x[t1][x + 8][y + 6][z + 8] + v_sol_x[t1][x + 8][y + 11][z + 8]) + 1.69180821680899e-1F * (v_sol_x[t1][x + 8][y + 7][z + 8] - v_sol_x[t1][x + 8][y + 10][z + 8])) + tau_sol_xy[t0][x + 8][y + 8][z + 8];
                      tau_sol_xz[t1][x + 8][y + 8][z + 8] = r30 * (2.53771232505914F * (r47 + v_sol_z[t1][x + 9][y + 8][z + 8]) + 1.47971564150281e-3F * (v_sol_z[t1][x + 5][y + 8][z + 8] - v_sol_z[t1][x + 12][y + 8][z + 8]) + 2.03016986020166e-2F * (-v_sol_z[t1][x + 6][y + 8][z + 8] + v_sol_z[t1][x + 11][y + 8][z + 8]) + 1.69180821680899e-1F * (v_sol_z[t1][x + 7][y + 8][z + 8] - v_sol_z[t1][x + 10][y + 8][z + 8])) + r31 * (2.53771232505914F * (r45 + v_sol_x[t1][x + 8][y + 8][z + 9]) + 1.47971564150281e-3F * (v_sol_x[t1][x + 8][y + 8][z + 5] - v_sol_x[t1][x + 8][y + 8][z + 12]) + 2.03016986020166e-2F * (-v_sol_x[t1][x + 8][y + 8][z + 6] + v_sol_x[t1][x + 8][y + 8][z + 11]) + 1.69180821680899e-1F * (v_sol_x[t1][x + 8][y + 8][z + 7] - v_sol_x[t1][x + 8][y + 8][z + 10])) + tau_sol_xz[t0][x + 8][y + 8][z + 8];
                      t_yy[t1][x + 8][y + 8][z + 8] = r28 + r29 + r32 * (5.91886256601123e-3F * r41 + 8.12067944080664e-2F * r42 + 6.76723286723597e-1F * r43 + 1.01508493002366e+1F * r44) + t_yy[t0][x + 8][y + 8][z + 8];
                      tau_sol_yz[t1][x + 8][y + 8][z + 8] = r31 * (2.53771232505914F * (r46 + v_sol_y[t1][x + 8][y + 8][z + 9]) + 1.47971564150281e-3F * (v_sol_y[t1][x + 8][y + 8][z + 5] - v_sol_y[t1][x + 8][y + 8][z + 12]) + 2.03016986020166e-2F * (-v_sol_y[t1][x + 8][y + 8][z + 6] + v_sol_y[t1][x + 8][y + 8][z + 11]) + 1.69180821680899e-1F * (v_sol_y[t1][x + 8][y + 8][z + 7] - v_sol_y[t1][x + 8][y + 8][z + 10])) + r32 * (2.53771232505914F * (r47 + v_sol_z[t1][x + 8][y + 9][z + 8]) + 1.47971564150281e-3F * (v_sol_z[t1][x + 8][y + 5][z + 8] - v_sol_z[t1][x + 8][y + 12][z + 8]) + 2.03016986020166e-2F * (-v_sol_z[t1][x + 8][y + 6][z + 8] + v_sol_z[t1][x + 8][y + 11][z + 8]) + 1.69180821680899e-1F * (v_sol_z[t1][x + 8][y + 7][z + 8] - v_sol_z[t1][x + 8][y + 10][z + 8])) + tau_sol_yz[t0][x + 8][y + 8][z + 8];
                      tau_sol_zz[t1][x + 8][y + 8][z + 8] = r27 + r29 + r31 * (5.91886256601123e-3F * r37 + 8.12067944080664e-2F * r38 + 6.76723286723597e-1F * r39 + 1.01508493002366e+1F * r40) + tau_sol_zz[t0][x + 8][y + 8][z + 8];
                    }
