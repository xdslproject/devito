...
void bf0(float *restrict r18_vec, float *restrict r19_vec, float *restrict r20_vec, float *restrict r21_vec, float *restrict r48_vec, float *restrict r49_vec, struct dataobj *restrict u_vec, struct dataobj *restrict v_vec, const int x_size, const int y_size, const int z_size, const int t0, const int x0_blk0_size, const int x_M, const int x_m, const int y0_blk0_size, const int y_M, const int y_m, const int z_M, const int z_m, const int nthreads);
void bf1(struct dataobj *restrict damp_vec, const float dt, struct dataobj *restrict epsilon_vec, float *restrict r17_vec, float *restrict r18_vec, float *restrict r19_vec, float *restrict r20_vec, float *restrict r21_vec, float *restrict r48_vec, float *restrict r49_vec, struct dataobj *restrict u_vec, struct dataobj *restrict v_vec, struct dataobj *restrict vp_vec, const int x_size, const int y_size, const int z_size, const int t0, const int t1, const int t2, const int x1_blk0_size, const int x_M, const int x_m, const int y1_blk0_size, const int y_M, const int y_m, const int z_M, const int z_m, const int nthreads);

int ForwardTTI(struct dataobj *restrict damp_vec, struct dataobj *restrict delta_vec, const float dt, struct dataobj *restrict epsilon_vec, const float o_x, const float o_y, const float o_z, struct dataobj *restrict phi_vec, struct dataobj *restrict src_vec, struct dataobj *restrict src_coords_vec, struct dataobj *restrict theta_vec, struct dataobj *restrict u_vec, struct dataobj *restrict v_vec, struct dataobj *restrict vp_vec, const int x_M, const int x_m, const int x_size, const int y_M, const int y_m, const int y_size, const int z_M, const int z_m, const int z_size, const int p_src_M, const int p_src_m, const int time_M, const int time_m, struct profiler * timers, const int x0_blk0_size, const int x1_blk0_size, const int y0_blk0_size, const int y1_blk0_size, const int nthreads, const int nthreads_nonaffine)
{
  ...
  float (*r48)[y_size + 1][z_size + 1];
  posix_memalign((void**)&r48, 64, sizeof(float[x_size + 1][y_size + 1][z_size + 1]));
  float (*r49)[y_size + 1][z_size + 1];
  posix_memalign((void**)&r49, 64, sizeof(float[x_size + 1][y_size + 1][z_size + 1]));
  ...
  for (int time = time_m, t0 = (time)%(3), t1 = (time + 1)%(3), t2 = (time + 2)%(3); time <= time_M; time += 1, t0 = (time)%(3), t1 = (time + 1)%(3), t2 = (time + 2)%(3))
  {
    ...
    bf1(damp_vec,dt,epsilon_vec,(float *)r17,(float *)r18,(float *)r19,(float *)r20,(float *)r21,(float *)r48,(float *)r49,u_vec,v_vec,vp_vec,x_size,y_size,z_size,t0,t1,t2,x1_blk0_size,x_M - (x_M - x_m + 1)%(x1_blk0_size),x_m,y1_blk0_size,y_M - (y_M - y_m + 1)%(y1_blk0_size),y_m,z_M,z_m,nthreads);
    bf1(damp_vec,dt,epsilon_vec,(float *)r17,(float *)r18,(float *)r19,(float *)r20,(float *)r21,(float *)r48,(float *)r49,u_vec,v_vec,vp_vec,x_size,y_size,z_size,t0,t1,t2,x1_blk0_size,x_M - (x_M - x_m + 1)%(x1_blk0_size),x_m,(y_M - y_m + 1)%(y1_blk0_size),y_M,y_M - (y_M - y_m + 1)%(y1_blk0_size) + 1,z_M,z_m,nthreads);
    bf1(damp_vec,dt,epsilon_vec,(float *)r17,(float *)r18,(float *)r19,(float *)r20,(float *)r21,(float *)r48,(float *)r49,u_vec,v_vec,vp_vec,x_size,y_size,z_size,t0,t1,t2,(x_M - x_m + 1)%(x1_blk0_size),x_M,x_M - (x_M - x_m + 1)%(x1_blk0_size) + 1,y1_blk0_size,y_M - (y_M - y_m + 1)%(y1_blk0_size),y_m,z_M,z_m,nthreads);
    bf1(damp_vec,dt,epsilon_vec,(float *)r17,(float *)r18,(float *)r19,(float *)r20,(float *)r21,(float *)r48,(float *)r49,u_vec,v_vec,vp_vec,x_size,y_size,z_size,t0,t1,t2,(x_M - x_m + 1)%(x1_blk0_size),x_M,x_M - (x_M - x_m + 1)%(x1_blk0_size) + 1,(y_M - y_m + 1)%(y1_blk0_size),y_M,y_M - (y_M - y_m + 1)%(y1_blk0_size) + 1,z_M,z_m,nthreads);
    /* End section1 */
    ...
    #pragma omp parallel num_threads(nthreads_nonaffine)
    {
      ...
      for (int p_src = p_src_m; p_src <= p_src_M; p_src += 1)
      {
        ...
        if (ii_src_0 >= x_m - 1 && ii_src_1 >= y_m - 1 && ii_src_2 >= z_m - 1 && ii_src_0 <= x_M + 1 && ii_src_1 <= y_M + 1 && ii_src_2 <= z_M + 1)
        {
          ...
          u[t1][ii_src_0 + 4][ii_src_1 + 4][ii_src_2 + 4] += r22;
        }
        if (ii_src_0 >= x_m - 1 && ii_src_1 >= y_m - 1 && ii_src_3 >= z_m - 1 && ii_src_0 <= x_M + 1 && ii_src_1 <= y_M + 1 && ii_src_3 <= z_M + 1)
        {
          ...
          #pragma omp atomic update
          u[t1][ii_src_0 + 4][ii_src_1 + 4][ii_src_3 + 4] += r23;
        }
        if (ii_src_0 >= x_m - 1 && ii_src_2 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_0 <= x_M + 1 && ii_src_2 <= z_M + 1 && ii_src_4 <= y_M + 1)
        {
          ...
          #pragma omp atomic update
          u[t1][ii_src_0 + 4][ii_src_4 + 4][ii_src_2 + 4] += r24;
        }
        if (ii_src_0 >= x_m - 1 && ii_src_3 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_0 <= x_M + 1 && ii_src_3 <= z_M + 1 && ii_src_4 <= y_M + 1)
        {
          ...
          #pragma omp atomic update
          u[t1][ii_src_0 + 4][ii_src_4 + 4][ii_src_3 + 4] += r25;
        }
        if (ii_src_1 >= y_m - 1 && ii_src_2 >= z_m - 1 && ii_src_5 >= x_m - 1 && ii_src_1 <= y_M + 1 && ii_src_2 <= z_M + 1 && ii_src_5 <= x_M + 1)
        {
          ...
          #pragma omp atomic update
          u[t1][ii_src_5 + 4][ii_src_1 + 4][ii_src_2 + 4] += r26;
        }
        if (ii_src_1 >= y_m - 1 && ii_src_3 >= z_m - 1 && ii_src_5 >= x_m - 1 && ii_src_1 <= y_M + 1 && ii_src_3 <= z_M + 1 && ii_src_5 <= x_M + 1)
        {
          ...
          #pragma omp atomic update
          u[t1][ii_src_5 + 4][ii_src_1 + 4][ii_src_3 + 4] += r27;
        }
        if (ii_src_2 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_5 >= x_m - 1 && ii_src_2 <= z_M + 1 && ii_src_4 <= y_M + 1 && ii_src_5 <= x_M + 1)
        {
          ...
          #pragma omp atomic update
          u[t1][ii_src_5 + 4][ii_src_4 + 4][ii_src_2 + 4] += r28;
        }
        if (ii_src_3 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_5 >= x_m - 1 && ii_src_3 <= z_M + 1 && ii_src_4 <= y_M + 1 && ii_src_5 <= x_M + 1)
        {
          ...
          #pragma omp atomic update
          u[t1][ii_src_5 + 4][ii_src_4 + 4][ii_src_3 + 4] += r29;
        }
        ...
        if (ii_src_0 >= x_m - 1 && ii_src_1 >= y_m - 1 && ii_src_2 >= z_m - 1 && ii_src_0 <= x_M + 1 && ii_src_1 <= y_M + 1 && ii_src_2 <= z_M + 1)
        {
          ...
          #pragma omp atomic update
          v[t1][ii_src_0 + 4][ii_src_1 + 4][ii_src_2 + 4] += r30;
        }
        if (ii_src_0 >= x_m - 1 && ii_src_1 >= y_m - 1 && ii_src_3 >= z_m - 1 && ii_src_0 <= x_M + 1 && ii_src_1 <= y_M + 1 && ii_src_3 <= z_M + 1)
        {
          ...
          #pragma omp atomic update
          v[t1][ii_src_0 + 4][ii_src_1 + 4][ii_src_3 + 4] += r31;
        }
        if (ii_src_0 >= x_m - 1 && ii_src_2 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_0 <= x_M + 1 && ii_src_2 <= z_M + 1 && ii_src_4 <= y_M + 1)
        {
          ...
          #pragma omp atomic update
          v[t1][ii_src_0 + 4][ii_src_4 + 4][ii_src_2 + 4] += r32;
        }
        if (ii_src_0 >= x_m - 1 && ii_src_3 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_0 <= x_M + 1 && ii_src_3 <= z_M + 1 && ii_src_4 <= y_M + 1)
        {
          ...
          #pragma omp atomic update
          v[t1][ii_src_0 + 4][ii_src_4 + 4][ii_src_3 + 4] += r33;
        }
        if (ii_src_1 >= y_m - 1 && ii_src_2 >= z_m - 1 && ii_src_5 >= x_m - 1 && ii_src_1 <= y_M + 1 && ii_src_2 <= z_M + 1 && ii_src_5 <= x_M + 1)
        {
          ...
          #pragma omp atomic update
          v[t1][ii_src_5 + 4][ii_src_1 + 4][ii_src_2 + 4] += r34;
        }
        if (ii_src_1 >= y_m - 1 && ii_src_3 >= z_m - 1 && ii_src_5 >= x_m - 1 && ii_src_1 <= y_M + 1 && ii_src_3 <= z_M + 1 && ii_src_5 <= x_M + 1)
        {
          ...
          #pragma omp atomic update
          v[t1][ii_src_5 + 4][ii_src_1 + 4][ii_src_3 + 4] += r35;
        }
        if (ii_src_2 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_5 >= x_m - 1 && ii_src_2 <= z_M + 1 && ii_src_4 <= y_M + 1 && ii_src_5 <= x_M + 1)
        {
...
void bf0(float *restrict r18_vec, float *restrict r19_vec, float *restrict r20_vec, float *restrict r21_vec, float *restrict r48_vec, float *restrict r49_vec, struct dataobj *restrict u_vec, struct dataobj *restrict v_vec, const int x_size, const int y_size, const int z_size, const int t0, const int x0_blk0_size, const int x_M, const int x_m, const int y0_blk0_size, const int y_M, const int y_m, const int z_M, const int z_m, const int nthreads)
{
  ...
  float (*restrict r48)[y_size + 1][z_size + 1] __attribute__ ((aligned (64))) = (float (*)[y_size + 1][z_size + 1]) r48_vec;
  float (*restrict r49)[y_size + 1][z_size + 1] __attribute__ ((aligned (64))) = (float (*)[y_size + 1][z_size + 1]) r49_vec;
  float (*restrict u)[u_vec->size[1]][u_vec->size[2]][u_vec->size[3]] __attribute__ ((aligned (64))) = (float (*)[u_vec->size[1]][u_vec->size[2]][u_vec->size[3]]) u_vec->data;
  float (*restrict v)[v_vec->size[1]][v_vec->size[2]][v_vec->size[3]] __attribute__ ((aligned (64))) = (float (*)[v_vec->size[1]][v_vec->size[2]][v_vec->size[3]]) v_vec->data;
      ...
      for (int y0_blk0 = y_m; y0_blk0 <= y_M; y0_blk0 += y0_blk0_size)
      {
        for (int x = x0_blk0; x <= x0_blk0 + x0_blk0_size - 1; x += 1)
        {
          for (int y = y0_blk0; y <= y0_blk0 + y0_blk0_size - 1; y += 1)
          {
            ...
            for (int z = z_m - 1; z <= z_M; z += 1)
            {
              float r53 = -v[t0][x + 4][y + 4][z + 4];
              r49[x + 1][y + 1][z + 1] = 1.0e-1F*(-(r53 + v[t0][x + 4][y + 4][z + 5])*r18[x + 1][y + 1][z + 1] - (r53 + v[t0][x + 4][y + 5][z + 4])*r19[x + 1][y + 1][z + 1]*r20[x + 1][y + 1][z + 1] - (r53 + v[t0][x + 5][y + 4][z + 4])*r20[x + 1][y + 1][z + 1]*r21[x + 1][y + 1][z + 1]);
              float r54 = -u[t0][x + 4][y + 4][z + 4];
              r48[x + 1][y + 1][z + 1] = 1.0e-1F*(-(r54 + u[t0][x + 4][y + 4][z + 5])*r18[x + 1][y + 1][z + 1] - (r54 + u[t0][x + 4][y + 5][z + 4])*r19[x + 1][y + 1][z + 1]*r20[x + 1][y + 1][z + 1] - (r54 + u[t0][x + 5][y + 4][z + 4])*r20[x + 1][y + 1][z + 1]*r21[x + 1][y + 1][z + 1]);
            }
          }
        }
      }
        ...
        for (int x = x1_blk0; x <= x1_blk0 + x1_blk0_size - 1; x += 1)
        {
          for (int y = y1_blk0; y <= y1_blk0 + y1_blk0_size - 1; y += 1)
          {
            ...
            for (int z = z_m; z <= z_M; z += 1)
            {
              float r60 = 1.0/dt;
              float r59 = 1.0/(dt*dt);
              float r58 = r18[x + 1][y + 1][z]*r49[x + 1][y + 1][z] - r18[x + 1][y + 1][z + 1]*r49[x + 1][y + 1][z + 1] + r19[x + 1][y][z + 1]*r20[x + 1][y][z + 1]*r49[x + 1][y][z + 1] - r19[x + 1][y + 1][z + 1]*r20[x + 1][y + 1][z + 1]*r49[x + 1][y + 1][z + 1] + r20[x][y + 1][z + 1]*r21[x][y + 1][z + 1]*r49[x][y + 1][z + 1] - r20[x + 1][y + 1][z + 1]*r21[x + 1][y + 1][z + 1]*r49[x + 1][y + 1][z + 1];
              float r57 = pow(vp[x + 4][y + 4][z + 4], -2);
              float r56 = 1.0e-1F*(-r18[x + 1][y + 1][z]*r48[x + 1][y + 1][z] + r18[x + 1][y + 1][z + 1]*r48[x + 1][y + 1][z + 1] - r19[x + 1][y][z + 1]*r20[x + 1][y][z + 1]*r48[x + 1][y][z + 1] + r19[x + 1][y + 1][z + 1]*r20[x + 1][y + 1][z + 1]*r48[x + 1][y + 1][z + 1] - r20[x][y + 1][z + 1]*r21[x][y + 1][z + 1]*r48[x][y + 1][z + 1] + r20[x + 1][y + 1][z + 1]*r21[x + 1][y + 1][z + 1]*r48[x + 1][y + 1][z + 1]) - 8.33333315e-4F*(u[t0][x + 2][y + 4][z + 4] + u[t0][x + 4][y + 2][z + 4] + u[t0][x + 4][y + 4][z + 2] + u[t0][x + 4][y + 4][z + 6] + u[t0][x + 4][y + 6][z + 4] + u[t0][x + 6][y + 4][z + 4]) + 1.3333333e-2F*(u[t0][x + 3][y + 4][z + 4] + u[t0][x + 4][y + 3][z + 4] + u[t0][x + 4][y + 4][z + 3] + u[t0][x + 4][y + 4][z + 5] + u[t0][x + 4][y + 5][z + 4] + u[t0][x + 5][y + 4][z + 4]) - 7.49999983e-2F*u[t0][x + 4][y + 4][z + 4];
              float r55 = 1.0/(r57*r59 + r60*damp[x + 1][y + 1][z + 1]);
              float r46 = r59*(-2.0F*u[t0][x + 4][y + 4][z + 4] + u[t2][x + 4][y + 4][z + 4]);
              float r47 = r59*(-2.0F*v[t0][x + 4][y + 4][z + 4] + v[t2][x + 4][y + 4][z + 4]);
              u[t1][x + 4][y + 4][z + 4] = r55*((-r46)*r57 + r56*(2*epsilon[x + 4][y + 4][z + 4] + 1) + 1.0e-1F*r58*r17[x + 1][y + 1][z + 1] + r60*(damp[x + 1][y + 1][z + 1]*u[t0][x + 4][y + 4][z + 4]));
              v[t1][x + 4][y + 4][z + 4] = r55*((-r47)*r57 + r56*r17[x + 1][y + 1][z + 1] + 1.0e-1F*r58 + r60*(damp[x + 1][y + 1][z + 1]*v[t0][x + 4][y + 4][z + 4]));
            }
          }
        }
      }
