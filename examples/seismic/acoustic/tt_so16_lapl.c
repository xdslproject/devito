...
#pragma omp simd aligned(u2 : 32)
                        for (int sp_zi = sp_zi_m; sp_zi <= nnz_sp_source_mask[x - time + 1][y - time + 1]; sp_zi += 1)
                        {
                          float r0 = save_src[time][source_id[x - time + 1][y - time + 1][sp_source_mask[x - time + 1][y - time + 1][sp_zi] + 1]] * source_mask[x - time + 1][y - time + 1][sp_source_mask[x - time + 1][y - time + 1][sp_zi] + 1];
                          u2[t1][x - time + 16][y - time + 16][sp_source_mask[x - time + 1][y - time + 1][sp_zi] + 16] += r0;
                        }
                      }
                    }
                  }
  ...
  /* Backdoor edit at Fri Jun 26 10:58:51 2020*/
  /* Backdoor edit at Fri Jun 26 11:16:20 2020*/
  /* Backdoor edit at Fri Jun 26 11:20:42 2020*/
  /* Backdoor edit at Fri Jun 26 11:22:37 2020*/
  /* Backdoor edit at Fri Jun 26 11:25:02 2020*/
  /* Backdoor edit at Fri Jun 26 11:35:54 2020*/
  /* Backdoor edit at Fri Jun 26 11:49:40 2020*/
  /* Backdoor edit at Fri Jun 26 12:52:39 2020*/
  /* Backdoor edit at Fri Jun 26 14:22:16 2020*/
  /* Backdoor edit at Fri Jun 26 14:25:07 2020*/
