  ...
  for (int time = time_m, t0 = (time) % (3), t1 = (time + 1) % (3), t2 = (time + 2) % (3); time <= time_M; time += 1, t0 = (time) % (3), t1 = (time + 1) % (3), t2 = (time + 2) % (3))
  {
    ...
    for (int p_src = p_src_m; p_src <= p_src_M; p_src += 1)
    {
      ...
      if (ii_src_0 >= x_m - 1 && ii_src_1 >= y_m - 1 && ii_src_2 >= z_m - 1 && ii_src_0 <= x_M + 1 && ii_src_1 <= y_M + 1 && ii_src_2 <= z_M + 1)
      {
        ...
        save_src[(source_id[ii_src_0 + 8][ii_src_1 + 8][ii_src_2 + 8])][time] += r0;
      ...
      if (ii_src_0 >= x_m - 1 && ii_src_1 >= y_m - 1 && ii_src_3 >= z_m - 1 && ii_src_0 <= x_M + 1 && ii_src_1 <= y_M + 1 && ii_src_3 <= z_M + 1)
      {
        ...
        save_src[(source_id[ii_src_0 + 8][ii_src_1 + 8][ii_src_3 + 8])][time] += r1;
      }
      if (ii_src_0 >= x_m - 1 && ii_src_2 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_0 <= x_M + 1 && ii_src_2 <= z_M + 1 && ii_src_4 <= y_M + 1)
      {
        ...
        save_src[(source_id[ii_src_0 + 8][ii_src_4 + 8][ii_src_2 + 8])][time] += r2;
      }
      if (ii_src_0 >= x_m - 1 && ii_src_3 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_0 <= x_M + 1 && ii_src_3 <= z_M + 1 && ii_src_4 <= y_M + 1)
      {
        ...
        save_src[(source_id[ii_src_0 + 8][ii_src_4 + 8][ii_src_3 + 8])][time] += r3;
      }
      if (ii_src_1 >= y_m - 1 && ii_src_2 >= z_m - 1 && ii_src_5 >= x_m - 1 && ii_src_1 <= y_M + 1 && ii_src_2 <= z_M + 1 && ii_src_5 <= x_M + 1)
      {
        ...
        save_src[(source_id[ii_src_5 + 8][ii_src_1 + 8][ii_src_2 + 8])][time] += r4;
      }
      if (ii_src_1 >= y_m - 1 && ii_src_3 >= z_m - 1 && ii_src_5 >= x_m - 1 && ii_src_1 <= y_M + 1 && ii_src_3 <= z_M + 1 && ii_src_5 <= x_M + 1)
      {
        ...
        save_src[(source_id[ii_src_5 + 8][ii_src_1 + 8][ii_src_3 + 8])][time] += r5;
      }
      if (ii_src_2 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_5 >= x_m - 1 && ii_src_2 <= z_M + 1 && ii_src_4 <= y_M + 1 && ii_src_5 <= x_M + 1)
      {
        ...
        save_src[(source_id[ii_src_5 + 8][ii_src_4 + 8][ii_src_2 + 8])][time] += r6;
      }
      if (ii_src_3 >= z_m - 1 && ii_src_4 >= y_m - 1 && ii_src_5 >= x_m - 1 && ii_src_3 <= z_M + 1 && ii_src_4 <= y_M + 1 && ii_src_5 <= x_M + 1)
      {
        ...
        save_src[(source_id[ii_src_5 + 8][ii_src_4 + 8][ii_src_3 + 8])][time] += r7;
      }
    }
  }
...
#pragma omp simd aligned(u, vp : 32)
                ...
                {
                  float r11 = vp[x - time + 8][y - time + 8][z + 8] * vp[x - time + 8][y - time + 8][z + 8];
                  u[t1][x - time + 8][y - time + 8][z + 8] = r11 * ((dt * dt) * (7.93650813e-6F * (-u[t0][x - time + 4][y - time + 8][z + 8] - u[t0][x - time + 8][y - time + 4][z + 8] - u[t0][x - time + 8][y - time + 8][z + 4] - u[t0][x - time + 8][y - time + 8][z + 12] - u[t0][x - time + 8][y - time + 12][z + 8] - u[t0][x - time + 12][y - time + 8][z + 8]) + 1.12874782e-4F * (u[t0][x - time + 5][y - time + 8][z + 8] + u[t0][x - time + 8][y - time + 5][z + 8] + u[t0][x - time + 8][y - time + 8][z + 5] + u[t0][x - time + 8][y - time + 8][z + 11] + u[t0][x - time + 8][y - time + 11][z + 8] + u[t0][x - time + 11][y - time + 8][z + 8]) + 8.8888891e-4F * (-u[t0][x - time + 6][y - time + 8][z + 8] - u[t0][x - time + 8][y - time + 6][z + 8] - u[t0][x - time + 8][y - time + 8][z + 6] - u[t0][x - time + 8][y - time + 8][z + 10] - u[t0][x - time + 8][y - time + 10][z + 8] - u[t0][x - time + 10][y - time + 8][z + 8]) + 7.11111128e-3F * (u[t0][x - time + 7][y - time + 8][z + 8] + u[t0][x - time + 8][y - time + 7][z + 8] + u[t0][x - time + 8][y - time + 8][z + 7] + u[t0][x - time + 8][y - time + 8][z + 9] + u[t0][x - time + 8][y - time + 9][z + 8] + u[t0][x - time + 9][y - time + 8][z + 8]) - 3.79629639e-2F * u[t0][x - time + 8][y - time + 8][z + 8]) + (2 * u[t0][x - time + 8][y - time + 8][z + 8] - u[t2][x - time + 8][y - time + 8][z + 8]) / r11);
                }
                //#pragma omp simd aligned(u : 32)
                for (int spzi = 0; spzi < sparse_source_mask_NNZ[x - time + 8][y - time + 8]; spzi++) // Inner block loop
                {
                  int zind = sparse_source_mask[x - time + 8][y - time + 8][spzi];
                  //printf("\n Dense z index zind is : %d", sparse_source_mask[x - time + 4][y - time + 4 - time][spzi]);
                  u[t1][x - time + 8][y - time + 8][zind] += source_mask[x - time + 8][y - time + 8][zind] * save_src[(source_id[x - time + 8][y - time + 8][zind])][tw + 1];
                  //printf("\n Source injection at grid[%d][%d][%d] with value src = %f, ", x - time + 4 - time, y + 4 - time, zind, save_src[(source_id[x - time + 4 - time][y - time + 4 - time][zind])][tw + 1]);
                }
              }
            }
          }
