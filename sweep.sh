...
for BLOCK_X in 4 8 16 32 64; do
    for BLOCK_Y in 4 8 16 32 64; do
        for BLOCK_Z in 4 8 16 32 64; do
            ...
            then
                ...
                DEVITO_PLATFORM=nvidiaX DEVITO_LANGUAGE=openacc DEVITO_ARCH=pgcc DEVITO_LOGGING=DEBUG python examples/seismic/acoustic/acoustic_example.py -so $ORDER -d $NX $NY $NZ --tn 688
            fi
        done
    done
done
